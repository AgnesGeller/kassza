const CACHE="diszkertek-kassza-v3";
const ASSETS=["./","index.html","styles.css","app.js","icon.svg","manifest.webmanifest","assets/diszkertek-logo.png","assets/diszkertek-emblem.png"];
